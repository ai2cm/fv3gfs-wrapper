...
if __name__ == '__main__':
    ...
    fail_if_unequal(checkpoint_data, checkpoint_data_disk, test_case='checkpoint memory vs disk')
    ...
    fail_if_unequal(checkpoint_data, checkpoint_reset_data, test_case='checkpoint reset')
    ...
    fail_if_unequal(first_time_data, second_time_data, test_case='end')
