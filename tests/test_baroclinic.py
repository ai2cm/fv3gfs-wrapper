...
files = [r'atmos_4xdaily_fine_inst.tile1.nc', r'atmos_4xdaily_fine_inst.tile2.nc', r'atmos_4xdaily_fine_inst.tile3.nc', r'atmos_4xdaily_fine_inst.tile4.nc', r'atmos_4xdaily_fine_inst.tile5.nc', r'atmos_4xdaily_fine_inst.tile6.nc']
...
for f in files:
    ...
    ps = ncfile.variables['ps'][:]/100. #convert to hPa
    ...
    if args.dir2:
        ...
        ps2 = ncfile.variables['ps'][:]/100. #convert to hPa
...
if args.dir2:
    ...
    for tt in range(len(tplot)):
        pres_date = np.concatenate((p[0,tt,:,:][0],p[1,tt,:,:][0],p[2,tt,:,:][0],p[3,tt,:,:][0],p[4,tt,:,:][0],p[5,tt,:,:][0]),axis=0)
        temp_date = np.concatenate((tarr[0,tt,:,:][0],tarr[1,tt,:,:][0],tarr[2,tt,:,:][0],tarr[3,tt,:,:][0],tarr[4,tt,:,:][0],tarr[5,tt,:,:][0]),axis=0)
